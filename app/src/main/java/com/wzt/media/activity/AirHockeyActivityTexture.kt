...
import com.wzt.media.renderer.AirHockeyRenderer3D
import com.wzt.media.renderer.AirHockeyRendererTexture
 ...
 *
 **/
class AirHockeyActivityTexture: Activity() {
...
//            glSurfaceView?.setEGLConfigChooser(8 , 8, 8, 8, 16, 0);
            ...
            // Assign our renderer.
            glSurfaceView?.setRenderer(AirHockeyRendererTexture(this))
            rendererSet = true;
        } else {
            /*
