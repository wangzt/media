...
class AirHockeyRenderer3(private val context: Context): GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(p0: GL10?, p1: EGLConfig?) {
        ...
        val vertexShaderSource: String = readTextFileFromResource(context, R.raw.simple_vertex_shader3)
        val fragmentShaderSource: String = readTextFileFromResource(context, R.raw.simple_fragment_shader3)
