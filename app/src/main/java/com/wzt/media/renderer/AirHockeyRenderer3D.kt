 ...
 *
 **/
class AirHockeyRenderer3D(private val context: Context): GLSurfaceView.Renderer {
...
//                -0.5f, 0.8f, 0f, 2f, 0.7f, 0.7f, 0.7f,
//                -0.5f, -0.8f, 0f, 1f, 0.7f, 0.7f, 0.7f,  // Line 1
//                -0.5f, 0f, 0f, 1.5f, 1f, 0f, 0f,
//                0.5f, 0f, 0f, 1.5f, 1f, 0f, 0f,  // Mallets
...
//        )
    ...
    override fun onSurfaceCreated(p0: GL10?, p1: EGLConfig?) {
        ...
        val vertexShaderSource: String = readTextFileFromResource(context, R.raw.simple_vertex_shader3d)
        val fragmentShaderSource: String = readTextFileFromResource(context, R.raw.simple_fragment_shader3d)
...
//        val aspectRation = if (width > height) width*1f/height else height*1f/width
//        if (width > height) {
//            // Landscape
...
//        }
        ...
        perspectiveM(projectionMatrix, 45f, width.toFloat()/height, 1f, 10f)
